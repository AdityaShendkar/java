...
public class Variables {
    ...
    public static void main(String[] args) {
        /*
         * ------------------------------------------------------------
         * Day 3: Variables in Java – Notes & Examples
         * ------------------------------------------------------------
         * 
         * Definition:
         * A variable is a named memory location that holds the data value of a
         ...
         * - Each variable has a specific data type that determines its range and
         * memory.
         ...
         * 
         * ------------------------------------------------------------
         * 💻 Code Example (Local Variable Scope)
         * ------------------------------------------------------------
         */
